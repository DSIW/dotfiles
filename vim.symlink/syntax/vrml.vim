...
" Last change:     1998 July 31

" included and modified syntax file:
" Language:	JavaScript
...
syn match   VRMLString            +""+
syn region  VRMLString            start=+"+  skip=+\\\\\|\\"+  end=+"+  contains=VRMLSpecial

if exists("VRML2_color_embedded_javascript")
  syn region  javaScriptLineComment      contained start="\/\/" end=+"+me=e-1
  ...
  syn region  javaScriptComment          contained start="/\*"  end=+\(\*/\|"\)+me=e-1 contains=javaScriptCommentString,javaScriptCharacter,javaScriptNumber
  ...
  "syn region  javaScriptParen       contained transparent start="(" end=")" contains=ALLBUT,javaScriptParenError
  "syn match   javaScriptParenError  contained ")"
  "syn match   javaScriptInParen     contained "[{}]"

  syn sync ccomment javaScriptComment
  syn region  VRMLJavaScript        start=+"\(javascript\|vrmlscript\):+  skip=+\\\\\|\\"+  end=+"+  contains=javaScriptLineComment,javaScriptCommentSkip,javaScriptCommentString,javaScriptComment2String,javaScriptComment,javaScriptSpecial,javaScriptStringD,javaScriptStringS,javaScriptSpecialCharacter,javaScriptNumber,javaScriptConditionall,javaScriptRepeat,javaScriptBranch,javaScriptOperator,javaScriptType,javaScriptStatement,javaScriptFunction,javaScriptBoolean,javaScriptBraces,javaScriptParen,javaScriptParenError,javaScriptInParen,VRMLTypes
endif
...
syn match   VRMLNumber            "\<\([-+]\=[0-9]*\.\=[0-9]\+\([eE][-+]\=[0-9]\+\)\=\|0[xX][0-9a-fA-F]\+\)\>"
...
if !exists("did_VRML2_syntax_inits")
  let did_VRML2_syntax_inits = 1
